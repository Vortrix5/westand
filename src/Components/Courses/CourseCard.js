...
import test from "../images/Courses/1.png"
import CourseModal from './CourseModal';
import logo from "../images/Courses/courseLogo.png"
...
function CourseCard(props) {
  const onView = (x)=>{
    props.dispatch({type:"ON_OPEN", payload:x})
    console.log("works")
  }
            ...
            {props.course.map(card => (
              <Grid item  xs={12} sm={6} md={4}>
                <Card    className={classes.card}>
                  ...
                  <CardActions>
                  <CourseModal trigger={<Button onClick={() => onView(card)} size="small" color="primary">
                      View
                    </Button>}/>
